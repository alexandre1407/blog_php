<?php /* Smarty version Smarty-3.1.15, created on 2015-01-16 22:29:23
...
<?php if ($_valid && !is_callable('content_54b29a7d719233_40025483')) {function content_54b29a7d719233_40025483($_smarty_tpl) {?><script type="text/javascript" src="../js/javascript.js"></script>
<div class="row">
    ...
    <div class="span8">
        ...
        <form action="inscription.php" method="post" enctype="multipart/form-data" id="inscription" name="inscription" onsubmit="verifinsc(this)">
